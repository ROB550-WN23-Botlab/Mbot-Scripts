...
tee /etc/startup_mailer.py << EOF
#!/usr/bin/python3
# -*- coding: utf-8 -*-
email_addresses = "email1@umich.edx, email2@umich.edx"
import subprocess
import smtplib
import socket
  ...
  <html>
      <body>
          <div style="padding:5px 20px;">
              <h1 style="font-size:20px;">Wifi IP Address Emailer Utility v2.0 <br>&copy; University of Michigan Robotics</h1>
